...
in {
  ...
  home-manager.users.${vars.user} = {
    xdg.configFile = {
      ...
      "swaync/style.css".text = with colours; ''
        @define-color cc-bg rgba(${rgb.bg}, 0.95);
        @define-color noti-border-color rgba(${rgb.currentLine}, 0.15);
        @define-color noti-bg ${hex.bg};
        @define-color noti-bg-darker rgb(43, 43, 57);
        @define-color noti-bg-hover ${hex.currentLine};
        @define-color noti-bg-focus rgba(${rgb.currentLine}, 0.6);
        @define-color noti-close-bg rgba(${rgb.currentLine}, 0.1);
        @define-color noti-close-bg-hover rgba(${rgb.currentLine}, 0.15);
